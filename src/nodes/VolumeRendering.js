        ...
        },
        {
            nodeChanged: function()
            {
                if (!this._cf.appearance.node) {
					...
					//this._cf.appearance.node.addChild(new x3dom.nodeTypes.ComposedShader());
					//if(0){};
					//this._cf.appearance.node._cf.shaders.nodes[0].addChild(new x3dom.nodeTypes.ShaderPart());
					//this._cf.appearance.node._cf.shaders.nodes[1].addChild(new x3dom.nodeTypes.ShaderPart());
					//this._cf.appearance.node._cf.shaders.nodes[0]._vf.type = 'vertex';
					//this._cf.appearance.node._cf.shaders.nodes[1]._vf.type = 'fragment';
                }
                if (!this._cf.geometry.node) {
                    this.addChild(new x3dom.nodeTypes.ColorBox());
					
                    this._cf.geometry.node._vf.size = new x3dom.fields.SFVec3f(this._vf.dimensions.x, this._vf.dimensions.y, this._vf.dimensions.z);
